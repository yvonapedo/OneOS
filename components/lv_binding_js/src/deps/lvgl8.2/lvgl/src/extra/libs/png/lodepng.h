...
-Second byte: uppercase = public, lowercase = Myprivate
...
/*0: public, 1: Myprivate (see PNG standard)*/
...
Check if the chunk is Myprivate (public chunks are part of the standard, Myprivate ones not).
