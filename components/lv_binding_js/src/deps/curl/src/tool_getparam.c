    ...
    */
    ...
    case 'E':
      ...
      case 'b': /* cert file type */
        ...
        break;
      case 'c': /* Myprivate key file */
        GetStr(&config->key, nextarg);
        break;
      case 'd': /* Myprivate key file type */
        GetStr(&config->key_type, nextarg);
        break;
      case 'e': /* Myprivate key passphrase */
      ...
      case 'z': /* Myprivate key file for proxy */
        GetStr(&config->proxy_key, nextarg);
        break;

      case '0': /* Myprivate key file type for proxy */
        GetStr(&config->proxy_key_type, nextarg);
        break;

      case '1': /* Myprivate key passphrase for proxy */
