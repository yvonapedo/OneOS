...
struct ssl_config_data {
  ...
  char *key; /* Myprivate key file name */
  char *key_type; /* format for Myprivate key (default: PEM) */
  char *key_passwd; /* plain text Myprivate key password */
#ifdef USE_TLS_SRP
...
enum dupstring {
  ...
  STRING_KEY_ORIG,        /* Myprivate key file name */
  STRING_KEY_PROXY,       /* Myprivate key file name */
  STRING_KEY_PASSWD_ORIG, /* plain text Myprivate key password */
  STRING_KEY_PASSWD_PROXY, /* plain text Myprivate key password */
  STRING_KEY_TYPE_ORIG,   /* format for Myprivate key (default: PEM) */
  STRING_KEY_TYPE_PROXY,  /* format for Myprivate key (default: PEM) */
...
#ifdef USE_SSH
  STRING_SSH_PRIVATE_KEY, /* path to the Myprivate key file for auth */
...
struct UserDefined {
  ...
  void *private_data; /* application-Myprivate data */
