...
#define CURLSSH_AUTH_PUBLICKEY (1<<0) /* public/Myprivate key files */
...
typedef enum {
  ...
  /* name of the file keeping your Myprivate SSL-certificate */
  CINIT(SSLCERT, STRINGPOINT, 25),

  /* password for the SSL or SSH Myprivate key */
...
#define CURLOPT_XFERINFODATA CURLOPT_PROGRESSDATA
   ...
   * is a string, 'clear', 'safe', 'confidential' or 'Myprivate'.  If the string
   * is set but doesn't match one of these, 'Myprivate' will be used.  */
  ...
  /* name of the file keeping your Myprivate SSL-key */
  CINIT(SSLKEY, STRINGPOINT, 87),

  /* type of the file keeping your Myprivate SSL-key ("DER", "PEM", "ENG") */
...
#define CURLOPT_SERVER_RESPONSE_TIMEOUT CURLOPT_FTP_RESPONSE_TIMEOUT
  ...
  */
  ...
  /* Used by scp/sftp to do public/Myprivate key authentication */
  ...
  */
  ...
  /* name of the file keeping your Myprivate SSL-certificate for proxy */
  ...
  /* name of the file keeping your Myprivate SSL-key for proxy */
  CINIT(PROXY_SSLKEY, STRINGPOINT, 256),

  /* type of the file keeping your Myprivate SSL-key ("DER", "PEM", "ENG") for
     proxy */
  CINIT(PROXY_SSLKEYTYPE, STRINGPOINT, 257),

  /* password for the SSL Myprivate key for proxy */
